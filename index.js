...
Person.prototype.eat = function (food) {
    return this.stomach.length < 10 ? this.stomach.push(food): console.log('This is too much food!');
    };
...
function Car(model="Ford",milesPerGallon = 18) {
	this.tank =  0;
	this.odometer = 0;
	this.model = model;
...
Car.prototype.drive = function (distance){
	let fuelConsumed = distance/this.milesPerGallon;
	  ...
	  if (this.tank <= fuelConsumed) {
	    fuelConsumed = this.tank;
